...
const Attendance = () => {
  ...
  <div id="main_content">
    ...
    <div id="left-sidebar" className="sidebar">
      ...
      <ul className="nav nav-tabs">
        <li className="nav-item"><a className="nav-link" data-toggle="tab" href="#menu-uni">University</a></li>
        <li className="nav-item"><a className="nav-link active" data-toggle="tab" href="#menu-admin">Admin</a></li>
      </ul>
      <div className="tab-content mt-3">
        <div className="tab-pane fade" id="menu-uni" role="tabpanel">
        ...
        <div className="tab-pane fade show active" id="menu-admin" role="tabpanel">
          <nav className="sidebar-nav">
            <ul className="metismenu">
              ...
              <li className="active"><a href="attendance.html"><i className="fa fa-calendar-check-o" /><span>Attendance</span></a></li>
      ...
      <div className="section-body">
        <div className="container-fluid">
          <div className="d-flex justify-content-between align-items-center ">
            ...
            <a href="javascript:void(0)" className="btn btn-info btn-sm">Export Excel</a>
          </div>
        </div>
      </div>
